(function(){function l(a){if(!a||typeof a!="object")return a;var b=new a.constructor,e;for(e in a)a.hasOwnProperty(e)&&(b[e]=l(a[e]));return b}function j(a,b){if(a){var e,d=0,c=a.length;if(c===void 0)for(e in a){if(b.call(a[e],e,a[e])===!1)break}else for(e=a[0];d<c&&b.call(e,d,e)!==!1;e=a[++d]);return a}}function n(a,b,e){if(typeof b!="object")return a;a&&b&&j(b,function(d,b){if(!e||typeof b!="function")a[d]=b});return a}function r(a){var b=a.indexOf(".");if(b!=-1){var e=a.slice(0,b)||"*",d=a.slice(b+
1,a.length),c=[];j(document.getElementsByTagName(e),function(){this.className&&this.className.indexOf(d)!=-1&&c.push(this)});return c}}function i(a){a=a||window.event;a.preventDefault?(a.stopPropagation(),a.preventDefault()):(a.returnValue=!1,a.cancelBubble=!0);return!1}function o(a,b,e){a[b]=a[b]||[];a[b].push(e)}function t(){return"_"+(""+Math.random()).slice(2,10)}function m(a,p,e){var d=this,h=null,m=!1,k,v,f=[],q={},s={},u,y,x,z,A,r;n(d,{id:function(){return u},isLoaded:function(){return h!==
null&&h.fp_play!==void 0&&!m},getParent:function(){return a},hide:function(b){if(b)a.style.height="0px";if(d.isLoaded())h.style.height="0px";return d},show:function(){a.style.height=r+"px";if(d.isLoaded())h.style.height=A+"px";return d},isHidden:function(){return d.isLoaded()&&parseInt(h.style.height,10)===0},load:function(b){if(!d.isLoaded()&&d._fireEvent("onBeforeLoad")!==!1){var f=0;j(c,function(){this.unload(function(){if(++f==c.length){if((k=a.innerHTML)&&!flashembed.isSupported(p.version))a.innerHTML=
"";if(b)b.cached=!0,o(s,"onLoad",b);flashembed(a,p,{config:e})}})})}return d},unload:function(b){if(this.isFullscreen()&&/WebKit/i.test(navigator.userAgent))return b&&b(!1),d;if(k.replace(/\s/g,"")!==""){if(d._fireEvent("onBeforeUnload")===!1)return b&&b(!1),d;m=!0;try{h&&(h.fp_close(),d._fireEvent("onUnload"))}catch(f){}setTimeout(function(){h=null;a.innerHTML=k;m=!1;b&&b(!0)},50)}else b&&b(!1);return d},getClip:function(a){a===void 0&&(a=z);return f[a]},getCommonClip:function(){return v},getPlaylist:function(){return f},
getPlugin:function(a){var f=q[a];if(!f&&d.isLoaded()){var e=d._api().fp_getPlugin(a);e&&(f=new b(a,e,d),q[a]=f)}return f},getScreen:function(){return d.getPlugin("screen")},getControls:function(){return d.getPlugin("controls")._fireEvent("onUpdate")},getLogo:function(){try{return d.getPlugin("logo")._fireEvent("onUpdate")}catch(a){}},getPlay:function(){return d.getPlugin("play")._fireEvent("onUpdate")},getConfig:function(a){return a?l(e):e},getFlashParams:function(){return p},loadPlugin:function(a,
...
function(a,b){b.call(d)});else if(b=="onPluginEvent"||b=="onBeforePluginEvent"){if(u=q[c.name||c])return u._fireEvent("onUpdate",c),u._fireEvent(p,a.slice(3))}else{if(b=="onPlaylistReplace"){f=[];var m=0;j(c,function(){f.push(new g(this,m++,d))})}if(b=="onClipAdd"){if(c.isInStream)return;c=new g(c,p,d);f.splice(p,0,c);for(i=p+1;i<f.length;i++)f[i].index++}var k=!0;if(typeof c=="number"&&c<f.length&&(z=c,(a=f[c])&&(k=a._fireEvent(b,p,u)),!a||k!==!1))k=v._fireEvent(b,p,u,a);j(s[b],function(){k=this.call(d,
c,p);this.cached&&s[b].splice(i,1);if(k===!1)return!1;i++});return k}}};if(typeof a=="string"){var w=document.getElementById(a);if(!w)throw"Flowplayer cannot access element: "+a;a=w}(function(){function h(a){var b=d.hasiPadSupport&&d.hasiPadSupport();if(/iPad|iPhone|iPod/i.test(navigator.userAgent)&&!/.flv$/i.test(f[0].url)&&!b)return!0;!d.isLoaded()&&d._fireEvent("onBeforeClick")!==!1&&d.load();return i(a)}$f(a)?($f(a).getParent().innerHTML="",x=$f(a).getIndex(),c[x]=d):(c.push(d),x=c.length-1);
...
i||(j(d.methods,function(){var b=""+this;h[b]=function(){var f=[].slice.call(arguments),f=c._api().fp_invoke(a,b,f);return f==="undefined"||f===void 0?h:f}}),i=!0)}return(d=g[b])?(d=d.apply(h,f),b.slice(0,1)=="_"&&delete g[b],d):h}})},c=[];window.flowplayer=window.$f=function(){var a=null,b=arguments[0];if(!arguments.length)return j(c,function(){if(this.isLoaded())return a=this,!1}),a||c[0];if(arguments.length==1)if(typeof b=="number")return c[b];else{if(b=="*")return new k(c);j(c,function(){if(this.id()==
b.id||this.id()==b||this.getParent()==b)return a=this,!1});return a}if(arguments.length>1){var e=arguments[1],d=arguments.length==3?arguments[2]:{};typeof e=="string"&&(e={src:e});e=n({bgcolor:"#000000",version:[9,0],expressInstall:"http://static.flowplayer.org/swf/expressinstall.swf",cachebusting:!1},e);if(typeof b=="string")if(b.indexOf(".")!=-1){var h=[];j(r(b),function(){h.push(new m(this,l(e),l(d)))});return new k(h)}else{var g=document.getElementById(b);return new m(g!==null?g:b,e,d)}else if(b)return new m(b,
e,d)}return null};n(window.$f,{fireEvent:function(){var a=[].slice.call(arguments),b=$f(a[0]);return b?b._fireEvent(a.slice(1)):null},addPlugin:function(a,b){m.prototype[a]=b;return $f},each:j,extend:n});if(typeof jQuery=="function")jQuery.fn.flowplayer=function(a,b){if(!arguments.length||typeof arguments[0]=="number"){var c=[];this.each(function(){var a=$f(this);a&&c.push(a)});return arguments.length?c[arguments[0]]:new k(c)}return this.each(function(){$f(this,l(a),b?l(b):{})})}})();
(function(){function l(){if(g.done)return!1;var b=document;if(b&&b.getElementsByTagName&&b.getElementById&&b.body){clearInterval(g.timer);g.timer=null;for(b=0;b<g.ready.length;b++)g.ready[b].call();g.ready=null;g.done=!0}}function j(b,c){if(c)for(key in c)c.hasOwnProperty(key)&&(b[key]=c[key]);return b}function n(b){switch(r(b)){case "string":return b=b.replace(RegExp('(["\\\\])',"g"),"\\$1"),b=b.replace(/^\s?(\d+)%/,"$1pct"),'"'+b+'"';case "array":return"["+i(b,function(a){return n(a)}).join(",")+
...
b.tagName=="A"))b.onclick=function(){location.href="http://www.adobe.com/go/getflashplayer"};if(!h&&c.onFail&&(e=c.onFail.call(this),typeof e=="string"))b.innerHTML=e;document.all&&(window[c.id]=document.getElementById(c.id))}var m=typeof jQuery=="function",k={width:"100%",height:"100%",allowfullscreen:!0,allowscriptaccess:"always",quality:"high",version:null,onFail:null,expressInstall:null,w3c:!1,cachebusting:!1};if(m)jQuery.tools=jQuery.tools||{},jQuery.tools.flashembed={version:"1.0.4",conf:k};
var g=m?jQuery:function(b){if(g.done)return b();g.timer?g.ready.push(b):(g.ready=[b],g.timer=setInterval(l,13))};window.attachEvent&&window.attachEvent("onbeforeunload",function(){__flash_unloadHandler=function(){};__flash_savedUnloadHandler=function(){}});window.flashembed=function(b,c,a){if(typeof b=="string"){var i=document.getElementById(b);if(i)b=i;else{g(function(){flashembed(b,c,a)});return}}if(b)return typeof c=="string"&&(c={src:c}),i=j({},k),j(i,c),new t(b,i,a)};j(window.flashembed,{getVersion:function(){var b=
...
6)return b}try{c=new ActiveXObject("ShockwaveFlash.ShockwaveFlash")}catch(e){}}typeof c=="object"&&(c=c.GetVariable("$version"),typeof c!="undefined"&&(c=c.replace(/^\S+\s+(.*)$/,"$1").split(","),b=[parseInt(c[0],10),parseInt(c[2],10)]))}return b},isSupported:function(b){var c=flashembed.getVersion();return c[0]>b[0]||c[0]==b[0]&&c[1]>=b[1]},domReady:g,asString:n,getHTML:o});if(m)jQuery.fn.flashembed=function(b,c){var a=null;this.each(function(){a=flashembed(this,b,c)});return b.api===!1?this:a}})();(function(){function l(){if(!m&&(m=!0,k)){for(var g=0;g<k.length;g++)k[g].call(window,[]);k=[]}}function j(g){var b=window.onload;window.onload=typeof window.onload!="function"?g:function(){b&&b();g()}}function n(){if(!t){t=!0;document.addEventListener&&!o.opera&&document.addEventListener("DOMContentLoaded",l,!1);o.msie&&window==top&&function(){if(!m){try{document.documentElement.doScroll("left")}catch(b){setTimeout(arguments.callee,0);return}l()}}();o.opera&&document.addEventListener("DOMContentLoaded",
function(){if(!m){for(var b=0;b<document.styleSheets.length;b++)if(document.styleSheets[b].disabled){setTimeout(arguments.callee,0);return}l()}},!1);if(o.safari){var g;(function(){if(!m)if(document.readyState!="loaded"&&document.readyState!="complete")setTimeout(arguments.callee,0);else{if(g===void 0){for(var b=document.getElementsByTagName("link"),c=0;c<b.length;c++)b[c].getAttribute("rel")=="stylesheet"&&g++;b=document.getElementsByTagName("style");g+=b.length}document.styleSheets.length!=g?setTimeout(arguments.callee,
0):l()}})()}j(l)}}var r=window.DomReady={},i=navigator.userAgent.toLowerCase(),o={version:(i.match(/.+(?:rv|it|ra|ie)[\/: ]([\d.]+)/)||[])[1],safari:/webkit/.test(i),opera:/opera/.test(i),msie:/msie/.test(i)&&!/opera/.test(i),mozilla:/mozilla/.test(i)&&!/(compatible|webkit)/.test(i)},t=!1,m=!1,k=[];r.ready=function(g){n();m?g.call(window,[]):k.push(function(){return g.call(window,[])})};n()})();(function(l,j){function n(b,c){return b.canPlayType(c)||a&&c.search("mp4")>-1}function r(b){for(var c=j.getElementsByTagName(b),d=[],e=0;e<c.length;e++)d.push(c[e]);for(e=0;e<d.length;e++){var c=d[e],g=!0;if(c.canPlayType)if(c.src)n(c,t(b,c.src))&&(g=!1);else for(var h=c.getElementsByTagName("source"),k=0;k<h.length;k++){var m=h[k];if(n(c,t(b,m.src,m.type))){g=!1;break}}g||i.forceFallback(b,c)?i.createFallback(b,c):a&&c.addEventListener("click",function(){this.play()},!1)}}function i(){r("video");
r("audio")}function o(a){return a.split("/").slice(0,-1).join("/")+"/"}function t(a,b,c){if(c)return c;if(b=/\.([a-z1-9]+)(\?|#|\s|$)/i.exec(b))if(b=B[a][b[1]])return b;return d[a]}function m(a,b){var c=a.getAttribute(b);return!!c||typeof c=="string"}function k(a){return a.substr(0,1)=="/"?C+a:a.substr(0,1)=="."||!a.match(/^\s*\w+:\/\//)?v+a:a}function g(a,b,c){var d=a.getAttribute(b);if(d)return d+"px";if(a.currentStyle)a=a.currentStyle[b];else if(l.getComputedStyle)a=j.defaultView.getComputedStyle(a,
null).getPropertyValue(b);else return c;return a=="auto"?c:a}function b(a){return a.match(/\s*([\w-]+\/[\w-]+)(;|\s|$)/)[1]}function c(a,c){return b(a)==b(c)}j.createElement("video").canPlayType||(j.createElement("audio"),j.createElement("source"));var a=l.navigator.userAgent.toLowerCase().match(/android 2\.[12]/)!==null,p=l.navigator.userAgent.toLowerCase().match(/opera/)!==null;i.forceFallback=function(){return!1};var e=function(){for(var a=j.getElementsByTagName("script"),b=0;b<a.length;b++){var c=
...
webm:"video/webm;"},audio:{ogg:'audio/ogg; codecs="vorbis"',oga:'audio/ogg; codecs="vorbis"',aac:"audio/x-m4a;",m4a:"audio/x-m4a;",mp3:"audio/mpeg;",wav:'audio/wav; codecs="1"'}},C=l.location.protocol+"//"+l.location.host,v=o(function(){for(var a=j.getElementsByTagName("base"),b=0;b<a.length;b++){var c=a[0];if(c.href)return c.href}return String(l.location)}());i.configureFlowplayer=function(a,b){return b};i.createFallback=function(a,b){var d=m(b,"controls"),e=b.getAttribute("poster")||"",n=b.getAttribute("src")||
"";if(!n)for(var l=b.getElementsByTagName("source"),o=0;o<l.length;o++){var r=l[o],v=r.getAttribute("src");if(v)for(var w=0;w<h.length;w++)if(c(h[w],t(a,v,r.getAttribute("type")))){n=v;break}if(n)break}if(n){l=j.createElement("span");l.id=b.id;l.style.cssText=b.style.cssText;l.className=b.className;l.title=b.title;l.style.display="block";l.style.width=g(b,"width","300px");l.style.height=a=="audio"?"26px":g(b,"height","200px");b.parentNode.replaceChild(l,b);r=(b.getAttribute("preload")||"").toLowerCase();
o=[];e&&o.push({url:k(e)});n&&o.push({url:k(n),autoPlay:m(b,"autoplay"),autoBuffering:m(b,"autobuffer")||m(b,"preload")&&(r===""||r=="auto"),onBeforeFinish:function(){return!m(b,"loop")}});e={controls:d&&{url:k(i.flowplayerControlsSwf),opacity:0.8,backgroundColor:"#181818",backgroundGradient:"none",fullscreen:a=="video",autoHide:a=="video"&&{fullscreenOnly:!1,enabled:!0,hideStyle:"fade",mouseOutDelay:0}||{enabled:!1}}||null};if(p&&e.controls)e.controls.autoHide.enabled=!1;if(a=="audio"){e.audio={url:k(i.flowplayerAudioSwf)};
if(!d)e.controls={url:k(i.flowplayerControlsSwf),display:"none"},l.style.height=0;o[o.length-1].autoBuffering=!1}d={play:null,playlist:o,clip:{scaling:"fit",fadeInSpeed:0,fadeOutSpeed:0},canvas:{backgroundGradient:"none",backgroundColor:"#000000"},plugins:e};d=i.configureFlowplayer(b,d);flowplayer(l,{src:k(i.flowplayerSwf),expressInstall:k(i.expressInstallSwf),wmode:"opaque"},d)}};DomReady.ready(i);l.html5media=i})(this,document);
